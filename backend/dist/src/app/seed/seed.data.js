...
async function seedUsers() {
    ...
    const doctorUsers = await Promise.all(doctorData.map((doctor) => prisma_1.prisma.user.create({
        data: {
            phone: doctor.phone,
            email: doctor.email,
            role: "doctor",
    ...
    const farmerUsers = await Promise.all(farmerData.map((farmer) => prisma_1.prisma.user.create({
        data: {
            phone: farmer.phone,
            email: farmer.email,
            role: "user",
    ...
    const clinicUsers = await Promise.all(clinicData.map((clinic) => prisma_1.prisma.user.create({
        data: {
            phone: clinic.phone,
            email: clinic.email,
            role: "clinic",
    ...
    const adminUsers = await Promise.all(adminData.map((admin) => prisma_1.prisma.user.create({
        data: {
            phone: admin.phone,
            email: admin.email,
            role: "admin",
...
async function seedDoctors(users) {
    const count = await prisma_1.prisma.doctor.count();
    if (count > 0) {
    ...
    const doc1 = await prisma_1.prisma.doctor.create({
        data: {
    ...
    const doc2 = await prisma_1.prisma.doctor.create({
        data: {
    ...
    const doc3 = await prisma_1.prisma.doctor.create({
        data: {
    ...
    const doc4 = await prisma_1.prisma.doctor.create({
        data: {
    ...
    const doc5 = await prisma_1.prisma.doctor.create({
        data: {
    ...
    const doc6 = await prisma_1.prisma.doctor.create({
        data: {
    ...
    const doc7 = await prisma_1.prisma.doctor.create({
        data: {
    ...
    const doc8 = await prisma_1.prisma.doctor.create({
        data: {
    ...
    const doc9 = await prisma_1.prisma.doctor.create({
        data: {
    ...
    const doc10 = await prisma_1.prisma.doctor.create({
        data: {
...
async function seedAvailability(doctors) {
    const count = await prisma_1.prisma.doctorAvailability.count();
    if (count > 0) {
    ...
    const entries = doctors.flatMap((doctor) => weekdays.map((dayOfWeek) => ({
        doctorId: doctor.id,
        dayOfWeek,
        startTime: "09:00",
        endTime: "17:00",
    ...
    await prisma_1.prisma.doctorAvailability.createMany({ data: entries });
    console.log("✅ Doctor availability seeded:", entries.length, "entries");
}
async function seedAnimals() {
    const count = await prisma_1.prisma.animal.count();
    if (count > 0) {
        console.log("ℹ️  Animals already seeded, skipping...");
        return;
    }
    console.log("Seeding animals...");
    await prisma_1.prisma.animal.createMany({
        data: [
            {
                name: "Donald Tramp",
...
async function seedCategoriesAndBrandsAndProducts() {
    const catCount = await prisma_1.prisma.category.count();
    if (catCount > 0) {
    ...
    const cat1 = await prisma_1.prisma.category.create({
        data: {
    ...
    const cat2 = await prisma_1.prisma.category.create({
        data: {
    ...
    const cat3 = await prisma_1.prisma.category.create({
        data: {
    ...
    const cat4 = await prisma_1.prisma.category.create({
        data: {
    ...
    const cat5 = await prisma_1.prisma.category.create({
        data: {
    ...
    const brand1 = await prisma_1.prisma.brand.create({
        data: {
    ...
    const brand2 = await prisma_1.prisma.brand.create({
        data: {
    ...
    const brand3 = await prisma_1.prisma.brand.create({
        data: {
            name: "Square Vet",
            slug: "square-vet",
            logo: "square.png",
    ...
    const brand4 = await prisma_1.prisma.brand.create({
        data: {
            name: "Kazi Vet",
            slug: "kazi-vet",
            logo: "square.png",
    ...
    const brand5 = await prisma_1.prisma.brand.create({
        data: {
            name: "Navana",
            slug: "navana",
            logo: "square.png",
    ...
    const prod1 = await prisma_1.prisma.product.create({
        data: {
    ...
    const prod2 = await prisma_1.prisma.product.create({
        data: {
    ...
    const prod3 = await prisma_1.prisma.product.create({
        data: {
    ...
    await prisma_1.prisma.inventoryLedger.createMany({
        data: [
...
async function seedClinicAndServices(users, doctors) {
    const count = await prisma_1.prisma.clinic.count();
    if (count > 0) {
    ...
    const clinic2 = await prisma_1.prisma.clinic.create({
        data: {
            userId: clinicManager.id,
    ...
    const clinic3 = await prisma_1.prisma.clinic.create({
        data: {
            userId: clinicManager.id,
    ...
    await prisma_1.prisma.clinicDoctor.createMany({
        data: doctors.map((d) => ({ clinicId: clinic.id, doctorId: d.id })),
    });
    await prisma_1.prisma.service.createMany({
        data: [
            {
                providerType: "clinic",
...
async function seedLivestock(users) {
    const count = await prisma_1.prisma.livestock.count();
    if (count > 0) {
        console.log("ℹ️  Livestock already seeded, skipping...");
        return prisma_1.prisma.livestock.findMany();
    }
    const farmer = users.find((u) => u.role === "user") || users[0];
    console.log("Seeding livestock...");
    const ls1 = await prisma_1.prisma.livestock.create({
        data: {
            sellerId: farmer.id,
            species: "cow",
    ...
    const ls2 = await prisma_1.prisma.livestock.create({
        data: {
            sellerId: farmer.id,
            species: "goat",
            breed: "Black Bengal",
...
async function seedChatMessages(users, doctors) {
    const count = await prisma_1.prisma.chatMessage.count();
    if (count > 0) {
...
async function seedCommerceAndEngagementData(users, doctors) {
    const addressCount = await prisma_1.prisma.address.count();
    if (addressCount > 0) {
        console.log("ℹ️  Commerce/engagement data already seeded, skipping...");
        return;
    }
    const farmer = users.find((u) => u.role === "user") || users[0];
    const product = await prisma_1.prisma.product.findFirst({ orderBy: { id: "asc" } });
    const livestock = await prisma_1.prisma.livestock.findFirst({ orderBy: { id: "asc" } });
    const doctor = doctors[0];
    ...
    // Addresses
    await prisma_1.prisma.address.createMany({
        data: [
            {
                userId: farmer.id,
                label: "Home",
    ...
    // Wishlist item
    await prisma_1.prisma.wishlistItem.create({
    ...
    // Reviews
    await prisma_1.prisma.review.createMany({
        data: [
            {
                userId: farmer.id,
                targetType: "product",
    ...
    // AI Diagnosis
    await prisma_1.prisma.aiDiagnosis.create({
        data: {
            userId: farmer.id,
            images: [],
...
async function backfillDemoCredentials() {
    const passwordHash = await bcryptjs_1.default.hash(SEED_PASSWORD, 10);
    const demoAccounts = [
        { phone: "+8801700000001", email: "doctor@gobadi.test", role: "doctor", name: "Dr. Michael Wilson" },
        { phone: "+8801800000001", email: "patient@gobadi.test", role: "user", name: "Test Farmer Patient" },
        { phone: "+8801800000002", email: "clinic@gobadi.test", role: "clinic", name: "Savar Clinic Manager" },
        { phone: "+8801900000001", email: "admin@gobadi.test", role: "admin", name: "Admin Supervisor" },
    ];
    let backfilled = false;
    for (const account of demoAccounts) {
        const user = await prisma_1.prisma.user.findFirst({ where: { phone: account.phone } });
        if (!user) {
