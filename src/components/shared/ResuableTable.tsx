                ...
                <div className="border-t border-[#5B5B5B33] px-4 sm:px-6 py-3.5 flex flex-col sm:flex-row items-center justify-between gap-3 bg-white">
                    ...
                    <div className="flex items-center gap-1.5">
                        <button
                            ...
                            className="w-8 h-8 rounded-lg border border-[#E5E0D8] flex items-center justify-center text-[#525252] hover:bg-[#F7F4EE] hover:text-[#1A1A1A] disabled:opacity-40 disabled:hover:bg-transparent cursor-pointer disabled:cursor-not-allowed transition-colors"
                        ...
                        <div className="min-w-8 h-8 px-2.5 rounded-lg border border-[#E5E0D8] flex items-center justify-center font-bold text-xs text-[#2563EB] bg-white">
