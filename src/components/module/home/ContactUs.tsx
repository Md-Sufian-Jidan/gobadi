...
export default async function ContactUs() {
    return (
        <section className="w-full relative bg-accent py-16 md:py-24 mt-16 md:mt-24" style={{
            backgroundImage: `
            ...
            {/* SVG Top Curve Transition */}
            <div className="absolute top-0 left-0 w-full overflow-hidden leading-none transform -translate-y-[99%]">
                <svg viewBox="0 0 1440 80" className="relative block w-full h-[40px] md:h-[80px] fill-accent" preserveAspectRatio="none">
                    <path d="M0,80 C360,20 1080,100 1440,30 L1440,80 L0,80 Z" />
                </svg>
            </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
                    ...
                    <div className="lg:col-span-7 flex flex-col gap-10">
                        <div className="flex flex-col items-start gap-4">
                            <h3 className="inline-flex items-center gap-2 bg-[#FFF6F3] py-1.5 px-4 md:py-2 md:px-5 rounded-full border border-white/10">
                            ...
                            <p className="text-white/80 font-normal text-base md:text-lg leading-relaxed max-w-xl">
                                Join the Gobaadi community and be part of a smarter future for animal care.
                            </p>
                        </div>
                    ...
                    {/* Right Column: Social Links & White Form Card */}
                    <div className="lg:col-span-5 w-full flex flex-col items-stretch lg:items-end">
                        ...
                        <div className="flex flex-col items-start lg:items-end gap-2 mb-6 px-1">
                            ...
                            <div className="flex gap-3">
                                {/* Facebook: solid white background, accent color logo */}
                        ...
                        <div className="bg-white rounded-[32px] p-6 md:p-8 shadow-2xl w-full max-w-[480px] mx-auto lg:mx-0">
                            <form className="flex flex-col gap-5">
                                ...
                                <button
                                    type="submit"
                                    className="w-full bg-[#C1652F] hover:bg-[#A34E1F] text-white font-bold py-4 rounded-xl flex items-center justify-center gap-2.5 transition-all shadow-md shadow-accent/15 cursor-pointer font-display mt-2"
                                >
